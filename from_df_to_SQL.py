...
# ## SO:
# ## 1- CREATE THREE SEPARATE DATAFRAME USING COLUMNS FROM CSV
# ## 2- THEN DATAFRAME.TO_SQL()
# ## 3- ADD ID UNIQUE AUTO_INCREMENT
# ## 4- CREATE REFERNCES BETWEEN TABLES TO REFERENCE RECORDS BASED ON INDEX
# ## 5- CREATE 'ADAPTABILITY_ID' ID IN TABLE BREEDS THAT REFERENCE TABLE 'BREED_GROUP'
